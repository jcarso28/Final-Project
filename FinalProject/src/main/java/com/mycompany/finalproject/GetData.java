            ...
            if (responsecode == 200) {
                ...
                for (int i = 0; i < sizeOfResults; i++) {
                    ...
                    if (jsonArray.get(1).getAsJsonArray().get(i).getAsJsonObject().get("value").isJsonNull()) {
                        populationForYear = 0;
                    } else // GET THE POPULATION FOR THE GIVEN YEAR FROM THE
                    // “value” FIELD
                    {
                    ...
                    cumulativePopulation = cumulativePopulation + populationForYear;

                }

                System.out.println("The average population over the selected years is " + cumulativePopulation / sizeOfResults);
